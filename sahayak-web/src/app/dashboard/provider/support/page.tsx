...
export default function ProviderSupportListPage() {
  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link className="btn" href="/dashboard/provider/support/new">New ticket</Link>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 gap-3">
          {data.map((t) => (
            <Link
              key={t._id}
              href={`/dashboard/provider/support/${t._id}`}
